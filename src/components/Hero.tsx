...
const Hero = () => {
    ...
    (() => {
        if (hasClicked) {
            ...
            gsap.to('#next-video', {
                ...
                ease: "power1.inOut",
                onStart: () => {
                    nextVdRef.current && nextVdRef.current.play()
                }
            })
    ...
    return (
        <div className="relative h-dvh w-screen overflow-x-hidden">
            {isLoading && <div className="flex-center absolute-center z-100 h-dvh w-screen overflow-hidden bg-violet-50">
            ...
            <div className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75" id="video-frame">
                ...
                <h1 className="special-font hero-heading absolute bottom-5 z-40 right-5
                text-blue-75">
                    G<b>a</b>ming
                </h1>
